...
{
    public class SingletonPageViewModel : BindableBase
    {
        ...
        public SingletonPageViewModel(INavigationService navigationService, ITheFirstService theFirstService)
        {
            _navigationService = navigationService;
            ListCustomer = new ObservableCollection<int>(theFirstService.ListCustomer);
